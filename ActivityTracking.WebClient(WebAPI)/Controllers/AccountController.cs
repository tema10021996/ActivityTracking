...
using ActivityTracking.WebClient_WebAPI_.Models;
using ActivityTracking.WebClient_WebAPI_.Providers;
using ActivityTracking.WebClient_WebAPI_.Results;

namespace ActivityTracking.WebClient_WebAPI_.Controllers
{
    [Authorize]
